...
from src.api.routers.companion import router as companion_router
from src.api.routers.dialogue import router as dialogue_router
from src.api.routers.player import router as player_router
from src.api.routers.game_state import router as game_state_router
from src.api.routers.npc import router as npc_router
from src.api.routers.npc_dialogue import router as npc_dialogue_router
from src.api.routers.deepseek_parameters import router as deepseek_parameters_router
