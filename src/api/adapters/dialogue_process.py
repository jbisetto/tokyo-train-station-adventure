...
from src.api.adapters.base import RequestAdapter, ResponseAdapter
from src.api.models.dialogue_process import DialogueProcessRequest, DialogueProcessResponse
...
class DialogueProcessResponseAdapter(ResponseAdapter):
    ...
    def adapt(self, response: InternalDialogueResponse) -> DialogueProcessResponse:
        ...
        Returns:
            The API response
        """
        from src.api.models.dialogue_process import (
            DialogueContent,
            FeedbackContent,
            NPCState,
            CompanionState,
