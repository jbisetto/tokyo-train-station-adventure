...
class AdapterFactory:
    ...
    def get_request_adapter(adapter_type: str) -> RequestAdapter:
        ...
        from src.api.adapters.companion_assist import CompanionAssistRequestAdapter
        from src.api.adapters.dialogue_process import DialogueProcessRequestAdapter
        from src.api.adapters.player_progress import PlayerProgressRequestAdapter
        from src.api.adapters.game_state import (
            GameStateSaveRequestAdapter,
            GameStateLoadRequestAdapter,
            GameStateListRequestAdapter
        )
        from src.api.adapters.npc import NPCConfigurationUpdateRequestAdapter
        from src.api.adapters.deepseek_parameters import DeepSeekParametersRequestAdapter
    ...
    def get_response_adapter(adapter_type: str) -> ResponseAdapter:
        ...
        """
        # Import adapters here to avoid circular imports
        from src.api.adapters.companion_assist import CompanionAssistResponseAdapter
        from src.api.adapters.dialogue_process import DialogueProcessResponseAdapter
        from src.api.adapters.player_progress import PlayerProgressResponseAdapter
        from src.api.adapters.game_state import (
            GameStateSaveResponseAdapter,
            GameStateLoadResponseAdapter,
            GameStateListResponseAdapter
        )
        from src.api.adapters.npc import (
            NPCInformationResponseAdapter,
            NPCConfigurationResponseAdapter,
            NPCInteractionStateResponseAdapter
        )
        from src.api.adapters.npc_dialogue import NPCDialogueResponseAdapter
        from src.api.adapters.deepseek_parameters import DeepSeekParametersResponseAdapter
