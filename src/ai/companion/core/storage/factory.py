"""
Tokyo Train Station Adventure - Storage Factory
...
from src.ai.companion.core.storage.base import ConversationStorage
...
from src.ai.companion.core.storage.config import StorageType, get_storage_config
