"""
Tokyo Train Station Adventure - Vector and Conversation Integration Example
...
async def main():
    ...
    try:
        ...
        third_request = ClassifiedRequest(
            ...
            processing_tier=ProcessingTier.TIER_2,
            game_context=GameContext(
                player_location="Tokyo Station Ticket Area",
        ...
        logger.info("3. TokyoKnowledgeStore - Provides relevant game world knowledge via vector search")
