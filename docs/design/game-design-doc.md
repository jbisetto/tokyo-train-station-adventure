...
### Week 1 (MVP)
- Complete the core booking ticket flow:
  - Information booth interaction
  - Ticket machine usage
  - Station attendant directions
  - Train conductor boarding
- Basic companion assistance functionality
- Simple save/load system

### Future Expansions
- Additional locations beyond the station
- More complex language challenges
- Expanded achievement system
- Additional transport types and destinations
